  ...
  return (
    <div className='bg-[url("./images/shlawp-background-2.png")] bg-cover h-full w-full'>
      ...
      <div className="rounded-lg p-[2px] bg-gradient-to-r from-yellow-400 to-pink-400">
        ...
        <div className="flex items-center justify-center pt-20 pb-32">
          <div className="flex w-full max-w-6xl mx-auto rounded-lg">
              <div className="w-2/5 justify-center p-5 text">
                <h1 className='text-4xl font-semibold pb-2'>Questions? We have answers.</h1>
                <h3 className='text-l text-gray-500 pb-5'>Here are some common questions we get asked.</h3>
              ...
              <div className="w-3/5 pt-3 text-white">
    ...
    <footer className="bg-black text-white py-4 pb-16">
        <div className="container mx-auto">
            <p className="mb-2 mt-12"> <span className=' text-5xl font-semibold'>Shlawp</span></p>
            <p className='flex pt-4'><div className='pr-2'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
              </svg>
              </div>shlawpco@gmail.com</p>
              <p className='flex pt-2'><div className='pr-2'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                  <path fillRule="evenodd" d="m11.54 22.351.07.04.028.016a.76.76 0 0 0 .723 0l.028-.015.071-.041a16.975 16.975 0 0 0 1.144-.742 19.58 19.58 0 0 0 2.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 0 0-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 0 0 2.682 2.282 16.975 16.975 0 0 0 1.145.742ZM12 13.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clipRule="evenodd" />
                </svg>
              </div>Irvine, California</p>
        </div>
    </footer>
</div>
    </div>
